...
def register_types(module):
    ...
    module.add_class('Ipv4AddressTrieEAccessTraits')
    ## trie.h (module 'network'): ns3::Ipv4AddressTrieEAccessTraits [enumeration]
    module.add_enum('', ['min_e_val', 'max_e_val', 'max_size'], outer_class=root_module['ns3::Ipv4AddressTrieEAccessTraits'])
    ...
    module.add_class('SimpleRefCount', automatic_type_narrowing=True, template_parameters=['ns3::Chunk', 'ns3::ObjectBase', 'ns3::DefaultDeleter<ns3::Chunk>'], parent=root_module['ns3::ObjectBase'], memory_policy=cppclass.ReferenceCountingMethodsPolicy(incref_method='Ref', decref_method='Unref', peekref_method='GetReferenceCount'))
    ...
    module.add_class('Chunk', parent=root_module['ns3::SimpleRefCount< ns3::Chunk, ns3::ObjectBase, ns3::DefaultDeleter<ns3::Chunk> >'])
    ...
    module.add_class('Tag', parent=root_module['ns3::Object'])
